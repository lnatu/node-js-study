...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHVsbmEiLCJhIjoiY2ticDIwaDdjMWVwZTJ2bzZ5bDN4d28xeiJ9.rHqT_3uZzU4LZ2pmia1vyg';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            (0, _alert.showAlert)('warning', 'Logging in');
            _context.prev = 1;
            _context.next = 4;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            console.log(_context2.t0.resposne);
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            (0, _alert.showAlert)('warning', 'Updating...');
            _context.prev = 1;
...
var stripe = Stripe('pk_test_51H2BKSIgATTpjFXQcJzlw9KDpQKKfScUNNZ38aWboBE6JCXkn3uLtYvxzwt8SKIBJ9OYokaD9OLWboysLcL9ZedR00kAsDqqkz');
...
var passwordCurrentInput = document.getElementById('password-current');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _login.login)(emailInput.value, passwordInput.value);
  });
}
